    ...
    return (
      <div className="py-5 mb-5 explore-banner">
        <div className="bg-brand300 position-relative py-md-5">
          ...
          {/* Content */}
          <div ref={this.exploreContainer} className="custom-container">
            <div className="row py-5">
              <div className="col-12 col-md-6 py-5">
                ...
                >
                  Chowis Skin and Hair Analyzers -
                </p>
                <p style={{ maxWidth: "25rem" }}>
                  are designed to cater to your business needs providing diagnostic solutions that
                  features: product recommendation, accurate diagnosis, progress monitoring, CRM,
                  apps with advanced algorithm, and professionally designed devices. We have
                  developed devices for professional skin analysis and hair analysis, as well as
                  devices specifically for home skin analysis and home hair analysis. The skin and
                  hair diagnosis results that you will get by using these devices are unparalleled
